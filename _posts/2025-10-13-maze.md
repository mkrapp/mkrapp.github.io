...
The maze (generator) below is using [*Kruskal's Algorithm*](https://en.wikipedia.org/wiki/Kruskal%27s_algorithm){:target="_blank"} and it is inspired by [Professor L.'s Maze Generation Algorithms - An Exploration](https://professor-l.github.io/mazes/){:target="_blank"}. You should check out her other mazes generation algorithms and corresponding explainers.
...
<button id="save">Click for PNG</button>
...
document.getElementById('save').addEventListener('click', () => {
    ...
    canvas.toBlob(blob => {
        ...
        // Open in a new tab instead of forcing download
